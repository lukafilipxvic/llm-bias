...
bias_models = {
    "bias-detection-model": {"name": "bias-detection model", "developer": "d4data"},
    "bias-detection": {"name": "bias-detection", "developer": "D1V1DE"},
}

with st.sidebar:
    st.header('LLM Bias Checker')
